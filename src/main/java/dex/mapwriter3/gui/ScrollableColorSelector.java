...
public class ScrollableColorSelector extends ScrollableField {
    ...
    private void init() {
        int textboxWidth = 16;
        int x1 = this.x + ScrollableField.arrowsWidth + this.fontrendererObj.getStringWidth(I18n.translate(this.editGreen)) + 4;
        int w = (ScrollableField.arrowsWidth * 2) + this.fontrendererObj.getStringWidth("999") + textboxWidth;

        this.ScrollableNumericTextBoxColourRed = new ScrollableNumericTextBox(x1, this.y, w, I18n.translate(this.editRed), this.fontrendererObj);
        ...
        this.ScrollableNumericTextBoxColourGreen = new ScrollableNumericTextBox(x1, this.y + MwGuiMarkerDialogNew.elementVSpacing, w, I18n.translate(this.editGreen), this.fontrendererObj);
        ...
        this.ScrollableNumericTextBoxColourBlue = new ScrollableNumericTextBox(x1, this.y + (MwGuiMarkerDialogNew.elementVSpacing * 2), w, I18n.translate(this.editBlue), this.fontrendererObj);
        ...
        this.colourFieldW = this.width - w - (ScrollableField.arrowsWidth * 2) - this.fontrendererObj.getStringWidth(I18n.translate(this.editGreen)) - 8;
