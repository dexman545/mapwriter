...
public class MwGuiMarkerDialogNew extends Screen {
    ...
    public MwGuiMarkerDialogNew(Screen parentScreen, MarkerManager markerManager, String markerName, String markerGroup, int x, int y, int z, DimensionType dimension) {
    ...
    public MwGuiMarkerDialogNew(Screen parentScreen, MarkerManager markerManager, Marker editingMarker) {
        this.markerManager = markerManager;
