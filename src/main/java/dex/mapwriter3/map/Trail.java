...
public class Trail {
    ...
    public Trail(Mw mw, String name) {
        this.mw = mw;
        this.name = name;
        this.enabled = ConfigurationHandler.configuration.getBoolean(this.name + "TrailEnabled", MwReference.catOptions, false, "");
        this.maxLength = ConfigurationHandler.configuration.getInt(this.name + "TrailMaxLength", MwReference.catOptions, this.maxLength, 1, 200, "");
        this.intervalMillis = ConfigurationHandler.configuration.getInt(this.name + "TrailMarkerIntervalMillis", MwReference.catOptions, (int) this.intervalMillis, 100, 360000, "");
    }
