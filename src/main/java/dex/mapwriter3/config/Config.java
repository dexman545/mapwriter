...
public class Config {
    ...
    public static largeMapModeConfig largeMap = new largeMapModeConfig(MwReference.catLargeMapConfig);
    public static smallMapModeConfig smallMap = new smallMapModeConfig(MwReference.catSmallMapConfig);
    public static MapModeConfig fullScreenMap = new MapModeConfig(MwReference.catFullMapConfig);
